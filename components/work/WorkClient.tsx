  ...
  return (
    <TimerProvider>
      <div className="space-y-5 animate-fade-in">
        ...
        <TimerManager userId={userId} onSessionSaved={refreshSessions} />

        <div className="grid gap-4 md:grid-cols-2">
          <TodoSection userId={userId} />
          <ReminderSection userId={userId} />
        </div>
        ...
        {sessions.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1">Start a timer or log a session manually</p>
          </div>
        ) : (
